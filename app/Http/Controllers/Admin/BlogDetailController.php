...
class BlogDetailController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.blog-details.index')->with('success', 'Blog detail created.');
    }
    ...
    public function update(Request $request, BlogDetail $blog_detail)
    {
        ...
        return redirect()->route('admin.blog-details.index')->with('success', 'Updated successfully.');
    }

    public function destroy(BlogDetail $blog_detail)
    {
        $blog_detail->delete();
        return redirect()->route('admin.blog-details.index')->with('success', 'Deleted successfully.');
    }
}
