              ...
              <div class="relative">
                ...
                <div class="w-full flex items-center justify-between text-[#fe8500] text-2xl p-2 font-bold">
                  <div class="flex items-center mt-1">
                    <img src="/images/discount_7939803.png" class="w-8" />
                  ...
                  <div
                    ...
                    <span class="text-sm flex mt-1 text-red-400">
                      <img src="./images/clock_4241462.png" class="w-8 h-9 pr-1" />
                    </span>
            ...
            <div
              ...
              <div class="relative">
                ...
                <div class=" w-full flex items-center justify-center text-[#fe8500] text-2xl p-2 font-bold ">
                  <div class=" flex items-center mt-1">
                    <img src="/images/discount_7939803.png" class="w-8" /> <span
                  ...
                  <div
                    ...
                    <!-- Days -->
                    <span class="text-sm flex mt-1 text-red-400"> <img src="./images/clock_4241462.png"
    ...
    <div class="container mx-auto">
      <div class=" flex flex-col lg:px-0 px-6 md:flex-row items-center  justify-between">
        <div class="flex items-center lg:gap-8 gap-4">
          <img src="https://via.placeholder.com/200" alt="Support illustration"
            class="lg:w-48 w-20 rounded-full shadow-md">
          <div>
