                  ...
                  <div class="flex flex-col md:flex-row items-center gap-6">
                      ...
                      <div class="relative group w-28 h-28">
                          <img src="https://via.placeholder.com/100" alt="Profile Picture"
                              class="w-full h-full rounded-full object-cover">
                          <div
                              class="absolute inset-0 bg-gray-200 border-gray-300  flex items-center justify-center group-hover:opacity-100 transition-opacity duration-300 rounded-full">
                              <button type="button"
                                  class="text-white text-sm px-3 py-2 bg-blue-600 rounded-lg hover:bg-blue-700 focus:ring-2 focus:ring-blue-500 focus:ring-offset-2">
                                  <i class="fas fa-camera"></i>
                              </button>
              ...
              <form class="space-y-6" id="personal-info-form">
                  ...
                  <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div>
                          ...
                          <input type="text" id="first-name" name="first-name" value="Vivek"
                              class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:border-gray-300">
                      </div>
                      <div>
                          <label for="last-name" class="block text-sm font-medium text-gray-700 mb-1">
                              <i class="fas fa-id-card text-black text-base mr-2"></i> Last Name
                  ...
                  <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div>
                          ...
                          <select name="gender" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:border-gray-300">
                  ...
                  <div>
                      ...
                      <textarea id="address" name="address" rows="3" placeholder="Enter your address"
                          class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:border-gray-300"></textarea>
                  </div>
          ...
          <div class="accordion-content mt-4 px-0 pt-2">
              ...
              <div class="space-y-6">
                ...
                <div class="bg-white rounded-xl shadow-lg p-3 transition duration-300 hover:shadow-xl">
                    <div class="flex flex-col md:flex-row gap-2">
                        <div class="w-full md:w-20">
                            <img src="/images/banner.png" alt="West Town 3rd Floor"
                        ...
                        <div class="flex-1 w-full">
                            <div class="grid grid-cols-1 md:grid-cols-5 gap-2">
                                <div class="col-span-3">
                                    ...
                                    <div class="flex mt-2 gap-x-4 w-full">
                                        <p class="text-xs text-gray-500"><i
                                                class="fas fa-dollar-sign mr-2 text-cyan-500"></i>Pay Amount:
                                            USD 1,234</p>
                                        <p class="text-xs text-gray-500"><i
                                                class="fas fa-users mr-2 text-cyan-500"></i>Guests: 1 (1
                                            Guest, 0 Children, 0 Infants)</p>
                                    </div>
                                </div>
                                <div>
                                ...
                                <div class="text-sm text-gray-600">
                                    <p><i class="fas fa-calendar-alt mr-2 text-cyan-500"></i><strong>date</strong>
                                        16/12/21 </p>
                    ...
                    Invoice</button> -->
                                <button
                                    ...
                                    Booking</button>
                                <button class="px-4 py-2 text-xs bg-blue-100 text-blue-700 rounded-lg hover:bg-blue-200 transition duration-300">Send
                                    Reminder Email</button>
                            </div>
                        </div>
                    </div>
        ...
        <div class="lg:flex flex-col lg:flex-row  hidden">
                ...
                <div id="tab-content">
                    <div id="personal-info" class="tab-content active py-10 lg:py-8  px-4 lg:p-8 max-w-4xl mx-auto">
                        ...
                        <form action="{{ route('user.profile.update') }}" method="POST" enctype="multipart/form-data"
                            class="space-y-6" id="personal-info-form">
                            @csrf
                            ...
                            <div>
                                ...
                                <select name="country_id" id="country_id"
                                    ...
                                    <option value="">Select your nationality</option>
                                    @foreach ($countries as $country)
                                    <option value="{{ $country->id }}" @selected(old('country_id', $user->country_id ??
                                        '') == $country->id)>
                                        {{ $country->name }}
                                    </option>
                                    @endforeach
                                        ...
                                        <div class="w-full">
                                            <div class="grid grid-cols-1 items-center md:grid-cols-3 gap-4">
                                                <div class="col-span-2">
                                                    <h3 class="text-lg font-medium text-gray-800">Booking Id
                                                        {{ $item->booking_id }}</h3>
            ...
            <div id="payment-method" class="tab-content max-w-4xl mx-auto p-8">
                <h2 class="text-2xl font-bold text-gray-800 mb-6">
                    ...
                    <p class="text-gray-600 mb-8">Select your preferred payment method and fill in the required details
                        below.
                    </p>
                        ...
                        <div id="credit-card-details" class="hidden">
                            ...
                            <div class="space-y-4">
                                ...
                                <div class="flex items-center">
                                    ...
                                    <label for="save-card" class="ml-2 text-gray-700">Save card details for future
                                        payments</label>
                                </div>
                            </div>
                        </div>
            ...
            paymentOptions.forEach((option) => {
                option.addEventListener("click", () => {
                    ...
                    // Hide all details
                    document.querySelectorAll("#payment-details > div").forEach((detail) => detail
