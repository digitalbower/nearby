        ...
        <div class="accordion-item mb-3">
            ...
            <div class="accordion-content mt-4 px-0 pt-2">
                ...
                <form action="{{ route('user.profile.update') }}" method="POST" enctype="multipart/form-data"
                    class="space-y-6 personal-info-form" id="personal-info-form">
                    @csrf

                    <!-- Profile Image -->
                    <div class="mb-4 flex justify-center">
                        @if($user->profile_picture)
                        <img id="profile-image-preview" src="{{ asset('storage/' . $user->profile_picture) }}"
                            alt="Profile Picture" class="w-24 h-24 rounded-full object-cover border border-gray-300">
                        @else
                        <div
                            class="w-24 h-24 rounded-full bg-gray-200 flex items-center justify-center border border-gray-300">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-10 w-10 text-gray-500" fill="currentColor"
                                viewBox="0 0 24 24">
                                <path
                    ...
                    <div>
                        ...
                        <select id="country_code_id" name="country_code_id"
                            ...
                            <option value="{{ $country->id }}" @selected(old('country_code_id', isset($user) ? $user->
                                country_code_id : null) == $country->id)>
                                {{ $country->name }}
                            </option>
                            @endforeach
                        </select>
                    ...
                    <div>
                        ...
                        <label for="country_of_residence_id" class="block text-sm font-medium text-gray-700">Country of
                            Residence</label>
                            ...
                            <div class="w-full">
                                <div class="grid">
                                    <div class="col-span-2">
                                        <h3 class="md:text-lg font-bold text-gray-800 pr-10">Booking Id
                                            {{ $item->bookingConfirmation->booking_id }}</h3>
                                        ...
                                        <div class="grid md:grid-cols-2 gap-y-2 gap-x-4">
                                            ...
                                            <p
                                                class="text-sm text-gray-600 bg-[#008000] text-white rounded-lg px-2 py-1 absolute top-5 right-2">
                                                Active
                                            </p>
                    ...
                    <div class="bg-white shadow rounded-lg p-4 mb-4">
                        <div class="flex justify-between items-center mb-2">
                            ...
                            <div class="flex items-center gap-4">
                                ...
                                <!-- Delete Form -->
                                <form method="POST" action="{{ route('user.profile.review.delete', $review->id) }}"
                                    class="contents">
                                    @csrf
                                    @method('DELETE')
                        ...
                        <div class="flex items-center gap-1 mb-2">
                            @for ($i = 1; $i <= 5; $i++) <i
                                class="fas fa-star {{ $i <= $review->review_rating ? 'text-yellow-400' : 'text-gray-300' }}">
                                </i>
                                @endfor
                        </div>
                ...
                <div id="edit-review-form" class="hidden bg-gray-50 p-4 rounded-lg shadow-md mt-6">
                    ...
                    <form method="POST" id="editForm">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="review_title" id="editTitle"
            ...
            <div class="lg:w-1/4 py-8 px-4 lg:px-10  bg-[#58af0838]">
                ...
                <nav class="space-y-1" id="sidebar">
                    <button data-tab="personal-info"
                        ...
                        <svg width="20px" height="20px" viewBox="0 0 1024 1024" fill="#000000" class="icon"
            ...
            <div class="lg:w-3/4 bg-white">
                <div id="tab-content">
                    <div id="personal-info" class="tab-content active py-10 lg:py-8  px-4 lg:p-8 max-w-5xl mx-auto">
                        ...
                        <form action="{{ route('user.profile.update') }}" method="POST" enctype="multipart/form-data"
                            ...
                            <div class="mb-4 flex justify-center">
                                ...
                                @else
                                <div
                                    class="w-28 h-28 rounded-full bg-gray-200 flex items-center justify-center border border-gray-300">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-14 w-14 text-gray-500"
                            ...
                            <div>
                                ...
                                <select name="country_id" id="country_id"
                                    ...
                                    <option value="">Select your nationality</option>
                                    @foreach ($countries as $country)
                                    <option value="{{ $country->id }}" @selected(old('country_id', $user->
                            ...
                            {{-- Country of Residence --}}
                            <div>
                                <label for="country_of_residence_id"
                    ...
                    <div id="booking" class="tab-content  max-w-5xl mx-auto p-8">
                        <div class="">
                            ...
                            <div class="flex gap-4 mb-8">
                                ...
                                <button onclick="filterBookingsAdvanced()"
                                    class="px-6 py-2 bg-cyan-500 text-white rounded-lg hover:bg-cyan-600 transition duration-300">
                                    Search
                                </button>
                            </div>
                                ...
                                <div class="booking-card mt-0 border relative border-[#58af0838] rounded-xl shadow-lg p-3 transition duration-300"
                                    ...
                                    <div class="flex flex-col md:flex-row gap-4">
                                        <div class="w-full">
                                            <div class="grid">
                                                <div class="col-span-2">
                                                    <h3 class="text-lg font-bold text-gray-800">Booking Id
                                                        {{ $item->bookingConfirmation->booking_id }}</h3>
                                                    <div class="text-sm my-2 text-gray-600">
                                                        <p>
                                                            <i class="fas fa-calendar-alt mr-2 text-gray-400"></i>
                                                    ...
                                                    <div class="grid md:grid-cols-2 gap-y-2 gap-x-4">
                                                        ...
                                                        @if($item->variant?->product?->types?->product_type === "Fixed
                                                        Date")
                                                        @if($item->variant?->holiday_length == 1)
                                                        <p class="text-sm text-gray-600">
                                                            Check In Date: {{ $item->check_in_date }}
                        ...
                        <div class="border border-gray-300 rounded-lg p-4 mb-4">
                            <div class="flex justify-between items-center">
                                <div>
                                    ...
                                    <div class="flex">
                                        @for ($i = 0; $i < 5; $i++) <i
                                            class="fas fa-star {{ $i < floor($review->review_rating) ? 'text-yellow-500' : 'text-gray-300' }}">
                                            </i>
                                            @endfor
                                    </div>
                                ...
                                <span>
                                    ...
                                    <form class="inline-flex"
                                        action="{{ route('user.profile.review.delete', $review->id) }}" method="POST"
                        ...
                        <div class="bg-white p-6 rounded shadow-md w-full max-w-lg">
                            ...
                            <form id="editReviewForm" method="POST">
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" name="review_title" id="editModalTitle"
                                ...
                                <div class="mb-4">
                                    <label for="editDescription"
                                        class="block text-gray-700 font-medium">Description</label>
                                    <textarea name="review_description" id="editModalDescription" rows="4"
                    ...
                    <div id="change-password" class="tab-content  max-w-5xl mx-auto p-8">
                        ...
                        <form class="space-y-6" id="change-password-form" method="POST"
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <input type="password" id="new-password_confirmation"
                                        name="new-password_confirmation" placeholder="Re-enter new password"
                                        class="w-full px-4 py-3 border border-gray-300 rounded-lg shadow-sm focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                                </div>
                            </div>
                    ...
                    <div id="payment-method" class="tab-content max-w-5xl mx-auto p-8">
                        <h2 class="text-2xl font-bold text-gray-800 mb-6">
                            ...
                            <p class="text-gray-600 mb-8">Select your preferred payment method and fill in the required
                                details below.
                            </p>
                            ...
                            <div id="saved-cards" class="space-y-4">
                                ...
                                <div
                                    ...
                                    <input type="radio" id="card2" name="saved-card"
                            ...
                            <div id="payment-options" class="space-y-6">
                                ...
                                <div data-method="credit-card"
                                    ...
                                    <div>
                                        ...
                                        <p class="text-sm text-gray-500">Pay securely using your credit or debit card.
                                        </p>
                                    </div>
                                </div>
                                <!-- Bank Transfer -->
                                <div data-method="bank-transfer"
                                    ...
                                    <div>
                                        ...
                                        <p class="text-sm text-gray-500">Directly transfer funds from your bank account.
                                        </p>
                                    </div>
                                </div>
                                <!-- PayPal -->
                                <div data-method="paypal"
                                    ...
                                    <div>
                                        ...
                                        <p class="text-sm text-gray-500">Use your PayPal account for a quick checkout.
                                        </p>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div id="credit-card-details" class="hidden">
                                    ...
                                    <div class="space-y-4">
                                        ...
                                        <div class="flex items-center">
                                            ...
                                            <label for="save-card" class="ml-2 text-gray-700">Save card details for
        ...
        function filterBookings(radio) {
            ...
            cards.forEach(card => {
                ...
                if (status === 'upcoming') {
                    ...
                    card.style.display = (cardStatus === 'expired' || cardStatus === 'redeemed') ? 'block' :
                        'none';
                } else {
