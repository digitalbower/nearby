...
@section('content')
   ...
   <div class="overflow-hidden z-10 py-20 bg-[#ebebeb] border-b-2 border-[#ebebeb]">
...
@endif
      ...
      <div class="space-y-4">
        ...
        <div class="relative">
         ...
         @php
            $redirectUrl = urlencode(request('redirect', '/'));
        @endphp
        <div class="grid grid-cols-1 gap-4 px-2">
    <a href="{{ route('user.auth.google', ['mode' => 'signin', 'state' => $redirectUrl]) }}"
